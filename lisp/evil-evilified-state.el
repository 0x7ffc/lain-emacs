...
(define-key evil-evilified-state-map "t" 'evil-next-visual-line)
(define-key evil-evilified-state-map "n" 'evil-previous-visual-line)
(define-key evil-evilified-state-map "s" 'evil-forward-char)
(define-key evil-evilified-state-map "k" 'evil-search-next)
(define-key evil-evilified-state-map "K" 'evil-search-previous)
